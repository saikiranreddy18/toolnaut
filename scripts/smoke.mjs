...
const routes = ['/', '/quiz?step=1', '/pricing', '/about', '/starchart', '/app/stack', '/app/discover', '/app/favorites', '/app/compare?tools=chatgpt,claude', '/app/learning', '/app/community', '/app/settings', '/office', '/s/chatgpt']
