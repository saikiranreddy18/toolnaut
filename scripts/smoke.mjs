...
const routes = ['/', '/goal', '/example', '/methodology', '/pricing', '/about', '/changelog', '/privacy', '/terms', '/app/stack', '/app/discover', '/app/favorites', '/app/compare?tools=chatgpt,claude', '/app/tools/chatgpt', '/app/learning', '/app/community', '/app/settings', '/office', '/s/chatgpt', '/tools/code', '/new', '/search?q=chatgpt']
