...
const SyntheticUsers = lazy(() => import('./pages/app/SyntheticUsers'))
const FeedbackSolutions = lazy(() => import('./pages/app/FeedbackSolutions'))
        ...
        <MotionConfig reducedMotion="user">
          <Routes>
            ...
            <Route path="/app" element={<AppShell />}>
              ...
              <Route path="feedback-solutions" element={<FeedbackSolutions />} />
            </Route>
