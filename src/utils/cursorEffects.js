...
export const CURSOR_EFFECTS = [
  ...
  return {
    ...
    frame(dt) {
      ...
      if (has) {
        ...
        if (idle > 0.05) {
          for (let i = 0; i < 3; i++) {
            ...
            ctx.fillStyle = 'rgba(228, 228, 231,' + (idle * (0.35 + 0.35 * Math.sin(time * 0.006 + i * 2.4))).toFixed(3) + ')';
            ctx.beginPath();
      ...
      for (let i = 0; i < PN; i++) {
        ...
        ctx.fillStyle = p.gold ? 'rgba(228, 228, 231,' + (a * 0.9).toFixed(3) + ')' : col(p.t, (a * 0.9).toFixed(3));
        ctx.beginPath();
      ...
      if (flashA > 0.02) {
        ...
        ctx.strokeStyle = 'rgba(228, 228, 231,' + (flashA * 0.8).toFixed(3) + ')';
      ...
      if (has) {
        ...
        g.addColorStop(0.2, 'rgba(228, 228, 231,0.85)');
        g.addColorStop(0.55, 'rgba(228, 228, 231,0.25)');
  ...
  return {
    ...
    frame(dt) {
      ...
      grad.addColorStop(0.3, 'rgba(161, 161, 170,0.45)');
  ...
  return {
    ...
    frame(dt) {
      ...
      grad.addColorStop(0, 'rgba(255,255,255,0.8)');
      grad.addColorStop(0.35, 'rgba(228, 228, 231,0.45)');
  ...
  return {
    ...
    frame(dt) {
      ...
      if (ringA > 0.01) {
        ...
        ctx.strokeStyle = 'rgba(161, 161, 170,' + (ringA * 0.07).toFixed(3) + ')';
        ctx.stroke();
        ctx.beginPath(); ctx.arc(mx, my, R * 0.45, 0, 6.2832);
        ctx.strokeStyle = 'rgba(161, 161, 170,' + (ringA * 0.05).toFixed(3) + ')';
        ctx.stroke();
      }
      if (pulse > 0.01) {
  ...
  return {
    ...
    frame(dt) {
      ...
      for (let i = 0; i < MAXA; i++) {
        ...
        ctx.strokeStyle = 'rgba(161, 161, 170,' + (0.35 * k * fl).toFixed(3) + ')';
        ctx.lineWidth = a.w * 3.2;
        ctx.stroke();
        ctx.strokeStyle = 'rgba(161, 161, 170,' + (0.8 * k * fl).toFixed(3) + ')';
      ...
      for (let i = 0; i < MAXS; i++) {
        ...
        ctx.fillStyle = k > 0.55 ? 'rgba(255,255,255,' + k.toFixed(3) + ')' : 'rgba(161, 161, 170,' + (k * 0.9).toFixed(3) + ')';
      ...
      if (seen) {
        ...
        g.addColorStop(0.25, 'rgba(161, 161, 170,' + (0.4 + e * 0.35).toFixed(3) + ')');
  ...
  return {
    ...
    frame(dt) {
      ...
      g.addColorStop(0, 'rgba(212, 212, 216,0)');
      g.addColorStop(0.3, 'rgba(212, 212, 216,0.14)');
      g.addColorStop(0.375, 'rgba(228, 228, 231,0.42)');
      g.addColorStop(0.46, 'rgba(212, 212, 216,0.12)');
      g.addColorStop(1, 'rgba(212, 212, 216,0)');
      ctx.fillStyle = g;
      ...
      ctx.globalAlpha = 1;
      ctx.lineWidth = 5; ctx.strokeStyle = 'rgba(228, 228, 231,0.32)';
      ...
      if (ringFlash > 0) {
        ctx.lineWidth = 6; ctx.strokeStyle = 'rgba(228, 228, 231,' + (0.5 * ringFlash).toFixed(3) + ')';
      ...
      for (let i = 0; i < MAXW; i++) {
        ...
        ctx.strokeStyle = 'rgba(228, 228, 231,' + (0.15 + 0.55 * t).toFixed(3) + ')';
      ...
      for (let i = 0; i < MAXF; i++) {
        ...
        g.addColorStop(0.4, 'rgba(228, 228, 231,' + (0.5 * f.life).toFixed(3) + ')');
        g.addColorStop(1, 'rgba(212, 212, 216,0)');
        ctx.fillStyle = g;
